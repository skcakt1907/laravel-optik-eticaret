...
@section('content')
<table class="table-a">
    <thead><tr><th>Gönderen</th><th>Konu / Mesaj</th><th>Tarih</th><th>Durum</th><th></th></tr></thead>
    <tbody>
    @forelse($messages as $m)
        <tr style="{{ $m->read_at ? '' : 'background:#f0fdfa' }}">
            <td>
    ...
    @empty
        <tr><td colspan="5" class="text-center text-muted py-4">Henüz iletişim mesajı yok.</td></tr>
    @endforelse
    </tbody>
</table>
